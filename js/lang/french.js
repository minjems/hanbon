// French phonetic mapping
import { decompose, isKoreanSyllable, isKoreanConsonant, isKoreanVowel, getChosungIndex, getJungsungIndex } from '../decompose.js';

const CHOSUNG_TO = ['g','g','n','d','d','l','m','b','b','s','s','','j','j','ch','k','t','p','h'];
const JUNGSUNG_TO = ['a','è','ya','yè','eu','é','yeu','yé','o','oua','oué','oé','yo','ou','oue','oué','ui','you','eu','eui','i'];
